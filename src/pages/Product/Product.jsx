                ...
                <main className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 container ">
                    ...
                    <section aria-labelledby="products-heading" className="pb-24 pt-6">
                        ...
                        <div className="grid grid-cols-1 gap-x-8 gap-y-10 lg:grid-cols-4">
                                                        ...
                                                        {section.options.map((option, optionIdx) => (
                                                            <div key={option.value} className="flex items-center">
                                                                <input
                                                                    ...
                                                                    type="checkbox"
                                                                    defaultChecked={option.checked}
                                                                    className="h-4 w-4 rounded border-green-300 text-green-600 focus:ring-green-500 bg-green-500"
                                                                />
                                                                <label
                            ...
                            {/* Product grid */}
                            <div className="lg:col-span-3 grid place-items-center  grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5">
